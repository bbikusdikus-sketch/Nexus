...
class CitySelector {
    constructor() {
        // Сначала инициализируем popularCities
        this.popularCities = [
        ...
        // Только потом загружаем город (чтобы popularCities был доступен)
    ...
    loadCity() {
        ...
        // По умолчанию — первый город из popularCities
        return this.popularCities[0]; // ← теперь this.popularCities определён
    }
